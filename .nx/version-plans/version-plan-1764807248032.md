...
- Creates root configuration files (ESLint, Prettier, RSBuild, Vitest, TypeScript)
...
- Includes build configuration (RSBuild), testing setup (Vitest), and linting (ESLint)
